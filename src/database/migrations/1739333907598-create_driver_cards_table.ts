...
export class CreateDriverCardsTable1739333907598 implements MigrationInterface {
    name = 'CreateDriverCardsTable1739333907598'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "driver_cards" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "driver_id" integer NOT NULL, "card_number" character varying NOT NULL, "card_holder" character varying NOT NULL, "expired_date" TIMESTAMP NOT NULL, "cvc_code" character varying NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "country" character varying NOT NULL, "postal_code" character varying NOT NULL, "phone_number" character varying NOT NULL, CONSTRAINT "PK_f1ded96b4438b6e0117e8d8eae1" PRIMARY KEY ("id"))`);
