...
export class AlterStoreNotificationsTable1742446987720 implements MigrationInterface {
    name = 'AlterStoreNotificationsTable1742446987720'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."store_notifications_type_enum" AS ENUM('order', 'promotion', 'news', 'store_update')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."store_notifications_type_enum_old" AS ENUM('news', 'order', 'promotion')`);
